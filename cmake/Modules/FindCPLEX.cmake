...
#   * since 12.10 on macOS studio is installed directly in /Applications via gui installer
#   /Applications/CPLEX_Studio<edition>124 - Mac OS X
#   C:\Program Files\IBM\ILOG\CPLEX_Studio<edition>124 - Windows

set(CPLEX_STUDIO_DIR /opt/cplex-12.6.1)
set(CPLEX_STUDIO_DIR_ /opt/cplex-12.6.1)

if (UNIX)
    set(CPLEX_ILOG_DIRS /opt/ibm/ILOG /opt/IBM/ILOG ${CPLEX_ILOG_ROOT_DIR})
    ...
    if (APPLE)
        set(CPLEX_ILOG_DIRS /Applications $ENV{HOME}/Applications $ENV{HOME}/Applications/IBM/ILOG ${CPLEX_ILOG_DIRS})
    ...
    set(CPLEX_ILOG_DIRS "C:/Program Files/IBM/ILOG" ${CPLEX_ILOG_ROOT_DIR})
    if (CMAKE_SIZEOF_VOID_P EQUAL 8)
        set(CPLEX_ARCH x64)
    else ()
        set(CPLEX_ARCH x86)
...
if(CPLEX_CP_FOUND)
    ...
    message(WARNING "CPLEX_FOUND : ${CPLEX_FOUND}")
endif()
if(CPLEX_CP_FOUND)
    message(STATUS "    CPLEX_INCLUDE_DIR : ${CPLEX_INCLUDE_DIR}")
    message(STATUS "    CPLEX_LINKED_LIBRARIES : ${CPLEX_LINK_LIBRARIES}")
    message(STATUS "    CPLEX_LIBRARY_DEBUG : ${CPLEX_LIBRARY_DEBUG}")
    message(STATUS "    CPLEX_LIBRARY : ${CPLEX_LIBRARY}")
    if (TARGET cplex-library)
        message(STATUS "    CMAKE_TARGET : cplex-library")
    else()
        message(WARNING "    CMAKE_TARGET : <missing>")
    endif()
endif()

if(CPLEX_CONCERT_FOUND)
    message(STATUS "CPLEX_CONCERT_FOUND : ${CPLEX_CONCERT_FOUND}")
else()
    message(WARNING "CPLEX_CONCERT_FOUND : ${CPLEX_CONCERT_FOUND}")
endif()
if(CPLEX_CONCERT_FOUND)
    message(STATUS "    CPLEX_CONCERT_INCLUDE_DIR : ${CPLEX_CONCERT_INCLUDE_DIR}")
    message(STATUS "    CPLEX_CONCERT_LINKED_LIBRARIES : ${CMAKE_THREAD_LIBS_INIT}")
    message(STATUS "    CPLEX_CONCERT_LIBRARY_DEBUG : ${CPLEX_CONCERT_LIBRARY_DEBUG}")
    message(STATUS "    CPLEX_CONCERT_LIBRARY : ${CPLEX_CONCERT_LIBRARY}")
    if (TARGET cplex-concert)
        message(STATUS "    CMAKE_TARGET : cplex-concert")
    else()
        message(WARNING "    CMAKE_TARGET : <missing>")
    endif()
endif()
...
if(CPLEX_ILOCPLEX_FOUND)
    message(STATUS "CPLEX_ILOCPLEX_FOUND : ${CPLEX_ILOCPLEX_FOUND}")
else()
    message(WARNING "CPLEX_ILOCPLEX_FOUND : ${CPLEX_ILOCPLEX_FOUND}")
endif()
if(CPLEX_ILOCPLEX_FOUND)
    message(STATUS "    CPLEX_ILOCPLEX_INCLUDE_DIR : ${CPLEX_ILOCPLEX_INCLUDE_DIR}")
    message(STATUS "    CPLEX_ILOCPLEX_LINKED_LIBRARIES : cplex-concert;cplex-library")
    message(STATUS "    CPLEX_ILOCPLEX_LIBRARY_DEBUG : ${CPLEX_ILOCPLEX_LIBRARY_DEBUG}")
    message(STATUS "    CPLEX_ILOCPLEX_LIBRARY : ${CPLEX_ILOCPLEX_LIBRARY}")
    if (TARGET ilocplex)
        message(STATUS "    CMAKE_TARGET : ilocplex")
    else()
        message(WARNING "    CMAKE_TARGET : <missing>")
    endif()
endif()
...
if(CPLEX_CP_FOUND)
    message(STATUS "CPLEX_CP_FOUND : ${CPLEX_CP_FOUND}")
else()
    message(WARNING "CPLEX_CP_FOUND : ${CPLEX_CP_FOUND}")
endif()
if(CPLEX_CP_FOUND)
    message(STATUS "    CPLEX_CP_INCLUDE_DIR : ${CPLEX_CP_INCLUDE_DIR}")
    message(STATUS "    CPLEX_CP_LINKED_LIBRARIES : cplex-concert;${CPLEX_CP_EXTRA_LIBRARIES}")
    message(STATUS "    CPLEX_CP_LIBRARY_DEBUG : ${CPLEX_CP_LIBRARY_DEBUG}")
    message(STATUS "    CPLEX_CP_LIBRARY : ${CPLEX_CP_LIBRARY}")
    if (TARGET cplex-cp)
        message(STATUS "    CMAKE_TARGET : cplex-cp")
    else()
        message(WARNING "    CMAKE_TARGET : <missing>")
    endif()
endif()